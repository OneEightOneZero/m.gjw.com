<template>
  <div>
    ...
    <!-- 导航 -->
    <div class="pro_nav" style="position: fixed; top: 45px; z-index: 88; width: 100%;">
      <div class="van-row" style="padding: 0px;">
        <div v-for="(goods, index) in goodslist" :key="index" class="van-col van-col--8">
          <span
            v-text="goods.title"
            @click="getactive(goods,index)"
        ...
        <div v-for="(m, index) in news" :key="index" class="van-col van-col--12">
          <div class="pro_item">
            <a href="#" @click="getrouter(index)">
              ...
              <div class="tip" v-text="`${m.SumComment}好评`">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 97%好评</div>
            </a>
          </div>
        </div>
      </div>
